...
public class ConfigProvider
{
	...
	{
		{
			...
			set("PreferEconomy","");// TODO: What economy system can I use?
	...
	public static List<String> getStringList(String key) throws ConfigException
	{
	...
	{
		return (T)config.get(key,defaults.get(key));
	}
}
